...
class MalwareDataset(Dataset):
    def __init__(self, csv_file, model_path, word2vec_path, is_onehot=True):
...
# 指定模型路径
# 数据集
def setDataLoader(train_path, test_path=None, batch_size=1):
    model_path = "./models/BERT"
    word2vec_path = "./utils/"
    All_dataloader = MalwareDataset(train_path, model_path, word2vec_path)
    if test_path is None:
        ...
        validate_dataset = MalwareDataset(test_path, model_path, word2vec_path)
